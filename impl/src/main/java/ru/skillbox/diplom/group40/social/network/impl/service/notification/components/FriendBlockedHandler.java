...
public class FriendBlockedHandler implements NotificationHandler {
    private final NotificationSettingsService notificationSettingsService;
    private final NotificationsMapper notificationsMapper;

    @Override
    public List<EventNotification> getEventNotificationList(NotificationDTO notificationDTO) {
        log.info("FriendBlockedHandler: getEventNotificationList(NotificationDTO notificationDTO) startMethod, " +
        ...
        log.info("FriendBlockedHandler: getEventNotificationList(_): Получен List listEventNotifications: {} " +
