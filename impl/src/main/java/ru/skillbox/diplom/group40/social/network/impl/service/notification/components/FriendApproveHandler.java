...
public class FriendApproveHandler implements NotificationHandler {
    private final NotificationSettingsService notificationSettingsService;
    private final NotificationsMapper notificationsMapper;

    @Override
    public List<EventNotification> getEventNotificationList(NotificationDTO notificationDTO) {
        log.info("FriendApproveHandler: getEventNotificationList(NotificationDTO notificationDTO) startMethod, " +
        ...
        log.info("FriendApproveHandler: getEventNotificationList(_): Получен List listEventNotifications: {} " +
