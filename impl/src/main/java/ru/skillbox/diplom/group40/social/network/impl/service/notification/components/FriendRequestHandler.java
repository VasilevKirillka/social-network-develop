...
public class FriendRequestHandler implements NotificationHandler {
    ...
    public List<EventNotification> getEventNotificationList(NotificationDTO notificationDTO) {
        log.info("FriendRequestHandler: getEventNotificationList(NotificationDTO notificationDTO) startMethod, " +
        ...
        log.info("FriendRequestHandler: getEventNotificationList(_): Получен List listEventNotifications: {} " +
