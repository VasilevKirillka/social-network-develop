...
public class FriendSubscribeHandler implements NotificationHandler {
    private final NotificationSettingsService notificationSettingsService;
    private final NotificationsMapper notificationsMapper;

    @Override
    public List<EventNotification> getEventNotificationList(NotificationDTO notificationDTO) {
        log.info("FriendSubscribeHandler: getEventNotificationList(NotificationDTO notificationDTO) startMethod, " +
        ...
        log.info("FriendSubscribeHandler: getEventNotificationList(_): Получен List listEventNotifications: {} " +
